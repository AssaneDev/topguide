      ...
      <div class="breadcumb-content">
        ...
        <div class="breadcumb-menu-wrap">
          <ul class="breadcumb-menu">
            ...
            <li>{{$namecat->category_name_en}}</li>
          </ul>
        </div>
      </div>
    </div>
      ...
      <div class="breadcumb-content">
        ...
        <div class="breadcumb-menu-wrap">
          <ul class="breadcumb-menu">
            ...
            <li>{{$namecat->category_name_es}}</li>
          </ul>
        </div>
      </div>
    </div>
            ...
            <div class="col-xl-6 col-md-6 col-sm-12 col-12">
              <div class="vs-blog blog-style2">
                ...
                <div class="blog-content">
                  ...
                  <div class="blog-bottom">
                    <a class="blog-date" href="{{ url('blog/detail/'.$item->post_slug) }}"><i class="fas fa-calendar-alt"></i> {{$item->created_at->format('d M Y')}}</a>
                    <a class="vs-btn has-arrow" href="{{ url('blog/detail/'.$item->post_slug) }}">Read More <i class="fal fa-arrow-right"></i></a>
                  </div>
                </div>
              </div>
            </div>
      ...
      <div class="row gx-30">
            ...
            <div class="col-xl-6 col-md-6 col-sm-12 col-12">
              <div class="vs-blog blog-style2">
                ...
                <div class="blog-content">
                  ...
                  <div class="blog-bottom">
                    <a class="blog-date" href="{{ url('blog/detail/'.$item->post_slug) }}"><i class="fas fa-calendar-alt"></i> {{$item->created_at->format('d M Y')}}</a>
                    <a class="vs-btn has-arrow" href="{{ url('blog/detail/'.$item->post_slug) }}">ver más<i class="fal fa-arrow-right"></i></a>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="col-lg-4">
          <div class="sidebar-area">
            ...
            <div class="widget widget-social">
              <h3 class="widget_title">Síguenos</h3>
              <div class="social-style widget_social_style">
                <a href="#" target="_blank"><i class="fab fa-facebook-f"></i></a>
                <a href="#" target="_blank"><i class="fab fa-instagram"></i></a>
