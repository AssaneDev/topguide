                  ...
                  <div class="col-lg-9">
                    <div class="filter-active tour-booking-active">
                      <div class="filter-item tab-content1">
                        <button type="submit" class="vs-btn style4"> <a href="{{route('formulaire.voyage')}}">Reservez Ma Place</a> </button>
</br>
                  ...
                  <div class="col-lg-3">
                    <div class="sidebar-area tours-sidebar">
                         ...
                         <div class="widget widget-newsletter">
                              ...
                              <a href="#" tabindex="0">🔢 Nombre Inscrit : {{$destination->nombre_participant}} </a> <br>
                              <a href="#" tabindex="0">⏳ Durée: {{$destination->dure_sejour}}</a><br>
                              
                              <a href="#" tabindex="0">💰 Prix actuel: {{$destination->prix}}€</a><br>
