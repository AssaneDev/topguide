        ...
        <div class="col-lg-6">
          <div class="image-box1">
            ...
            <div class="media-box1">
              <span class="media-info">25 année</span>
              <p class="media-text">D'Experience</p>
            </div>
            <div class="media-box2">
              <span class="media-info">1000+</span>
              <p class="media-text">Clients Satisfait</p>
            </div>
          </div>
        </div>
        <div class="col-lg-5">
          <div class="about-content">
            ...
            <a href="about.html" class="vs-btn style4">Entrer en contact</a>
          </div>
        </div>
      </div>
    </div>
