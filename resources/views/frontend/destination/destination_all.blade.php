        ...
        <div class="col-xl-4 col-lg-6 col-sm-6 filter-item hightTolow">
          <div class="package-style1">
            <div class="package-img">
              <a href="{{ url('destination/detail/'.$desti->id) }}"><img src="{{asset($desti->image_cap)}}" alt="Package Image"></a>
            </div>
            <div class="package-content">
              ...
              <h3 class="package-title"><a href="{{ url('destination/detail/'.$desti->id) }}" > {{$desti->name}} </a></h3>
              <p class="package-text">{{$desti->lieux}}</p>
              <div class="package-meta">
                <a href="{{ url('destination/detail/'.$desti->id) }}"><i class="fas fa-calendar-alt"></i> Jours: {{$desti->dure_sejour}}</a>
                <a href="{{ url('destination/detail/'.$desti->id) }}"><i class="fas fa-user"></i> Offres: 2</a>
              </div>
              <div class="package-footer">
                <span class="package-price">{{$desti->prix}} €/Pers</span>
                <a href="{{ url('destination/detail/'.$desti->id) }}"class="vs-btn">Voir detail</a>
              </div>
            </div>
          </div>
        </div>
