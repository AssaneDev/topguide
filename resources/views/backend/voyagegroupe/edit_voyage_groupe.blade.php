...
<div class="page-content">
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        <div class="breadcrumb-title pe-3">Modifier Voyage</div>
        <div class="ps-3">
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <form class="row g-3"  action="{{route('update.voyage')}}" method="post" enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <label for="input1"  class="form-label">Types Voyage</label>
                                                <input  type="text" name="type_voyage"  class="form-control mb-10" id="input1" value="{{$dataDesti->type_voyage}}" >
                                                ...
                                                <input  type="text" name="nbr_participant"  class="form-control mb-10" id="input1"value="{{$dataDesti->nombre_participant}}" >
