                        ...
                        <form class="row g-3"  action="{{route('store.excursion')}}" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <label for="input1"  class="form-label">Prix Excursion</label>
                                                ...
                                                <input  type="text" name="type_excursion"  class="form-control mb-10" id="input1" >
                                                <label for="input1"  class="form-label">Lieux</label>
                                                <input  type="text" name="lieux"  class="form-control mb-10" id="input1" >
                                                <label for="input1"  class="form-label">Durée Excursion</label>
                                                <input  type="number" name="dure_excursion"  class="form-control mb-10" id="input1" >
